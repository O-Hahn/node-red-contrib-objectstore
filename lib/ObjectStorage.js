...
ObjectStorage.prototype.listContainerFiles = function () {
	...
	return Request(options, this).then(function (response, body) {
		console.log('ListContainerFiles', body);
...
ObjectStorage.prototype.uploadFileToContainer = function (filename, mimetype, buffer, size){
	...
	return Request(options, this).then(function () { return `${this.url}/${filename}` });
}
